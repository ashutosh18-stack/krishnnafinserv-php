...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->Body    = "
            ...
            <p><b>Message:</b> " . nl2br(htmlspecialchars($_POST['message'])) . "</p>
        ";
...
if (file_exists($cache_file) && time() - filemtime($cache_file) < $cache_time) {
    $reviews_json = file_get_contents($cache_file);
} else {
    $reviews = [];
    $csv_url = REVIEWS_CSV;
    ...
    if (($handle = fopen($csv_url, "r")) !== FALSE) {
        ...
        file_put_contents($cache_file, $reviews_json);
    }
}
?>
...
<style>
/* Social icons */
.social-container { display:flex; gap:25px; width:auto; padding:12px 30px; background:#f4f7fa; border-radius:50px; border:1px solid #e2e8f0; transition:all 0.4s ease; }
.social-link { font-size:1.8rem; display:flex; align-items:center; justify-content:center; text-decoration:none; transition:all 0.3s ease; }
.wa-link { color:#25D366; } .insta-link { color:#E1306C; }
</style>
...
<section class="contact-section">
    <div class="contact-card" id="contactSection">
        <div class="contact-visual">
            <img src="static/img/hero-section2.jpg" alt="Our Team" class="contact-img" loading="lazy">
...
let allReviews = [];
try { allReviews = JSON.parse(dataBridge.getAttribute('data-reviews')); } catch(e){ console.error(e); }
let showingAll = false;

function displayReviews() {
    const grid = document.getElementById('testimonial-grid'); if(!grid) return;
    grid.innerHTML = '';
    if(!allReviews || allReviews.length===0){ grid.innerHTML='<p>No live reviews found.</p>'; return; }
    ...
    displayList.forEach(rev=>{
        ...
        <div class="col-md-4 mb-4">
            <div class="testimonial-card shadow-sm p-4 h-100" style="background:white;border-radius:10px;">
                <div class="stars mb-2" style="color:#ffc107;">${'★'.repeat(starCount)}${'☆'.repeat(Math.max(0,5-starCount))}</div>
                <p class="testimonial-text">"${reviewText}"</p>
                <div class="d-flex align-items-center mt-3">
                    <div class="initial-circle me-2" style="background:#112847;color:white;width:40px;height:40px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-weight:bold;">${initial}</div>
...
function toggleReviews(){ showingAll=!showingAll; displayReviews(); }
document.addEventListener('DOMContentLoaded', displayReviews);
</script>

<!-- Lazy Load Google Map -->
<section class="map-section">
    <div id="mapContainer" style="width:100%;height:450px;position:relative;cursor:pointer;">
        <div style="position:absolute;top:0;left:0;width:100%;height:100%;background:#eee;display:flex;align-items:center;justify-content:center;">
...
mapContainer.addEventListener('click', function loadMap(){
    ...
    iframe.src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3822.3524001236747!2d74.23258807514861!3d16.65923988410905!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTbCsDM5JzMzLjMiTiA3NMKwMTQnMDYuNiJF!5e0!3m2!1sen!2sin!4v1767902174271!5m2!1sen!2sin";
    iframe.width="100%"; iframe.height="450"; iframe.style.border="0"; iframe.loading="lazy";
    mapContainer.innerHTML=""; mapContainer.appendChild(iframe);
});
</script>
